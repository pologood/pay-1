...
public class XmlPacket {
    ...
    private static final Logger logger = LoggerFactory.getLogger(XmlPacket.class);
    ...
    public String toXmlString() {
        StringBuffer sfData = new StringBuffer("<?xml version='1.0' encoding = 'utf-8'?>");
    ...
    public static XmlPacket valueOf(String message) {
        ...
        try {
            ...
            logger.error("【解析xml字符串】异常" + e.getMessage());
