...
//      requestPMap.put("spbill_create_ip", params.getString("buyerIp"));   //买家IP
        ...
        boolean
                signMd5 =
                SecretKeyUtil.tenCheckMd5sign(prepayPMap, md5securityKey, prepayPMap.getString("sign"),
    ...
    public ResultMap preparePayInfoQRCode(PMap params) throws ServiceException {
        ...
        //6.返回二维码链接
        result.addItem("returnUrl", prepayPMap.getString("code_url"));//二维码链接
        return result;
    }
    ...
    public ResultMap preparePayInfoSDK(PMap params) throws ServiceException {
        ...
        result.addItem("returnData", requestPMap);
        return result;
    }
    ...
    public ResultMap refundOrder(PMap params) throws ServiceException {
        ...
        boolean
                signMd5 =
                SecretKeyUtil
                        .tenCheckMd5sign(responsePMap, md5securityKey, responsePMap.getString("sign"),
                                WechatService.INPUT_CHARSET);
        if (!signMd5) {
