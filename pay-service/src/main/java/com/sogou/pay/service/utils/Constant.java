...
public class Constant {
  ...
  public static final String TEST_ALIPAY = "TEST_ALIPAY";
  //财付通编码
  public static final String TENPAY = "TENPAY";
  public static final String TEST_TENPAY = "TEST_TENPAY";
  //微信扫码支付
  public static final String WECHAT = "WECHAT";
  public static final String TEST_WECHAT = "TEST_WECHAT";
  /**
   * 支付机构支付方式*
   */
  //网关支付
