 ...
 * Time: 下午8:31
 */
public class RequestModelXmlGBK extends RequestModel {

    private static final Logger logger = LoggerFactory.getLogger(RequestModelXmlGBK.class);
     ...
     */
    public RequestModelXmlGBK(String url, String rootNodeName) {
        super(url);
        ...
        this.setHEADER_CONTENT_TYPE_VALUE("application/x-www-form-urlencoded;charset=gbk");
    }
