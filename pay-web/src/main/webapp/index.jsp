...
商户订单数据
	...
	<input type="text" id="pageUrl" name="pageUrl" value="http://center.pay.sogou.com/notify/testBgUrl">支付结果前台通知页面(不为空，必须是合法URL,字节数不超过256)<br>
    <input type="text" id="bgUrl" name="bgUrl" value="http://center.pay.sogou.com/notify/testBgUrl">支付结果后台通知地址(不为空，必须是合法URL,字节数不超过256)<br>
	...
	<input type="text" id="accountId" name="accountId" value="xiaoming">可为空付款方账号<br>
	...
	<input type="text" id="productName" name="productName" value="测试商品">产品名称(字节数不能超过128字节)<br>
