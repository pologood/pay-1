...
+function ($) {
  ...
  Modal.prototype.backdrop = function (callback) {
    ...
    if (this.isShown && this.options.backdrop) {
      ...
      this.$backdrop = $('<div class="modal-backdrop ' + animate + '"  style="width:100%;height:'+ document.body.scrollHeight +'"/>')
        .appendTo($('body'))
...
$(function(){
	...
	$(".bankUp").click(function(e){
		...
		$(this).parent().find('ul').css("height","52px");
	});
	$(".sm").change(function(){
		if($(this).attr("value")=="ALIPAY" && $(this).attr("data-flag")=="SY"){
			$(".QR-Code-WeChat").hide();
			$(".QR-Code-Ali").show();
	...
	var i = 0;
	$(document).on('click','[data-target="paySubmit"]',function (e) {
		/*$('#toPayTip').modal('show');
		$("#payForm").attr("target","newWin");
		...
		$("#payForm").submit();
//		window.open("about:blank","newWin" + i,"");
		i++;
		return false;
