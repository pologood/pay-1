...
//    private PayApi payApi;
     ...
     */
    @RequestMapping(value = "/pay/getQrCode", produces = "application/json; charset=utf-8")
    @ResponseBody
     ...
     */
    @RequestMapping(value = {"/pay/doPayForWechat", "/api/pay/qrcode"}, produces = "application/json; charset=utf-8")
    @ResponseBody
    ...
    @RequestMapping(value = "/pay/getSignData", produces = "application/json; charset=utf-8")
    @ResponseBody
